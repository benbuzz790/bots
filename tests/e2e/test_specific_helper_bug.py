...
class TestSpecificHelperBug(unittest.TestCase):
    ...
    def test_view_dir_tool_after_save_load(self):
        ...
        try:
            _ = view_dir(".", target_extensions="['py']", max_lines=10)
        ...
        if view_dir_func and hasattr(view_dir_func, "__globals__"):
            helpers_before = [
                name
                for name in view_dir_func.__globals__.keys()
        ...
        if loaded_view_dir_func and hasattr(loaded_view_dir_func, "__globals__"):
            helpers_after = [
                name
                for name in loaded_view_dir_func.__globals__.keys()
        ...
        try:
            _ = loaded_bot.tool_handler.function_map["view_dir"](".", target_extensions="['py']", max_lines=10)
