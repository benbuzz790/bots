...
def test_branch_self_powershell_bug():
    ...
    if "0/1" in all_text and ("failed" in all_text.lower() or "error" in all_text.lower()):
        ...
        print("\nâÅ““ BUG REPRODUCED: branch_self reported 0/1 branches succeeded")
        ...
        print("\nâÅ““ BUG REPRODUCED: PowerShellManager not being defined error")

        pytest.fail("Bug reproduced: PowerShellManager not being defined")

    elif "Tool Failed" in all_text:

        print("\nâÅ““ BUG REPRODUCED: Tool Failed error")
        ...
        print("\nâÅ“— NO BUG: PowerShell executed successfully and returned 'test123'")
