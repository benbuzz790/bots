...
try:
    ...
    result = python_edit(
        target_scope="test_replace_behavior.py::TestClass::new_method",
    ...
    result = python_edit(
        target_scope="test_replace_behavior.py::TestClass",
...
"""
    ...
    # Replace func2
    result = python_edit(
        target_scope="test_functions.py::func2",
        code="""def func2():
...
"""
    ...
    result = python_edit(
        target_scope="test_nested.py::Outer::Inner::inner_method",
