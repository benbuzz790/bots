...
class TestCLILoad(unittest.TestCase):
    ...
    def test_load_handles_extension_automatically(self, mock_bot_load, mock_exists, mock_input):
        """Test that load function automatically adds .bot extension if needed."""
