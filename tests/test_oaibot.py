...
class TestGPTBot(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        with standard test configuration. Creates a test file with known content
...
def main() -> None:
    ...
    Executes a subset of tests in sequence for development and debugging purposes.
    Tests are run individually rather than through unittest framework to allow
    for precise control and observation of test execution.
