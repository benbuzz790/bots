...
This module tests the parallel branching capabilities of the functional_prompts module:

Functions tested:
    - par_branch: Creates multiple parallel conversation branches
    - par_branch_while: Creates iterative parallel branches with custom stop conditions
...
def test_par_branch_while_structure() -> None:
    ...
    This test verifies the complex behavior of parallel branches with iteration:
