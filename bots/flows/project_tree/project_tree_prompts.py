...
class prompts:
    ...
    def root_make_bots():
        return textwrap.dedent("""
            ...
            INSTRUCTION: Use initialize_file_bot to create a set of file bots. These bots will
            be responsible for writing their implementation file and their own test file.
    ...
    def file_create_files(bot_name: str):
        bot_name = bot_name.removesuffix('.bot')
        return textwrap.dedent(f"""INSTRUCTION: You are {bot_name}. 
            Please:
