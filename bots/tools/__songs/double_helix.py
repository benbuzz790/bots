...
def play_double_helix():
    ...
    print("🧬 'Double Helix' - Two-Voice Perpetual Motion 🧬\n")
    print("=" * 60)
    ...
    print(f"\n{result}")
    print("\n" + "=" * 60)
    print("✨ Counterpoint Features: ✨")
    print("  • Two voices, both in continuous 16th notes")
    print("  • Parallel motion (voices move together)")
    print("  • Contrary motion (voices move apart)")
    print("  • Interweaving (voices cross and weave)")
    print("  • Canon-like imitation (one follows the other)")
    print("  • Convergence (voices come together)")
