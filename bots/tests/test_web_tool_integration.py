...
class TestWebToolManualInspection(unittest.TestCase):
    ...
    def test_manual_web_search_inspection(self):
        ...
        print("="*80)
        print(f"Query: latest Python 3.12 features")
    ...
    def test_web_search_result_structure_expectations(self, mock_anthropic_class):
        ...
        mock_response.content = [
            ...
            Mock(text=None, type='web_search_tool_result', content=[
        ...
        mock_response.__str__ = Mock(return_value=str({
            'search_results': [
    ...
    def test_web_search_with_citations(self, mock_anthropic_class):
        ...
        mock_response.content = [
            ...
            Mock(text="Python 3.12 includes many new features", citations=[
                {'url': 'https://python.org', 'title': 'Python 3.12 Release'}
            ])
        ]
