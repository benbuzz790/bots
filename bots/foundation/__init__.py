...
with Language Models that are instruct-tuned and have tool-using capabilities.
It includes base classes and specific implementations for different LLM
providers.
...
The foundation module emphasizes:
    ...
    - Comprehensive tool use capabilities - any Callables, modules, or python
      files can be tools.
