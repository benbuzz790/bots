...
def find_files_needing_style_fixes(start_path: str) -> Tuple[List[str], List[str]]:
...
def main():
    ...
    files_needing_fixes, files_already_passing = find_files_needing_style_fixes(project_root)
    ...
    bots = [
        ...
        for n, file in enumerate(files_needing_fixes)
    ]
